...
[_NUM] = LAYOUT_planck_grid(
    _______, _______, KC_UP  , _______, _______, _______, _______, KC_7   , KC_8, KC_9  , KC_MINS, _______,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_4   , KC_5, KC_6  , KC_PLUS, _______,
    _______, KC_HOME, _______, KC_END , _______, _______, _______, KC_1   , KC_2, KC_3  , KC_BSLS, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_0, KC_DOT, KC_ASTR, _______
),
