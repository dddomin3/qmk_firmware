...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , _______, _______, KC_LCBR, KC_RCBR, KC_PIPE,
...
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, KC_1   , KC_2, KC_3  , KC_BSLS, _______, _______, KC_HOME, _______, KC_END , _______, _______,
    _______, _______, KC_0, KC_DOT, KC_ASTR, _______, _______, _______, _______, _______, _______, _______
),
